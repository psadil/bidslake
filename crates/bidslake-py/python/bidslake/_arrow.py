...
The Rust side serializes each result set to an Arrow IPC *stream*; Polars reads it back
with `polars.read_ipc_stream`. This is the one place that bridges the native query
primitive to a DataFrame.
"""
